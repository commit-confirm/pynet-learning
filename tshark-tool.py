...
## Possible issues
"""
 * Total amount of occurences in top talkers is not equal to the amount of packets captured. I suspect this is due to the ip filter in the tshark command. L2 packets may count towards the capture count but be filtered out from the results and thus not stored/analysed by the script
